...
router.get('/home/customer/orders/:customerId/:status', orderController.get_orders);
...
router.post('/verify-payment', orderController.verifyPaystackPayment); // Updated to POST
