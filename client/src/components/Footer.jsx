    ...
    return (
        <footer className='bg-[#191919]'>
            <div className='w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-white'>
                            ...
                            <li>Phone : +23480 3378 4107</li>
                            <li>Email : ridanexpress@gmail.com</li>
                            <li>Support : ridanservice @gmail.com</li>
                        </ul>
                    </div>
                </div>
                <div className='w-5/12 lg:w-8/12 sm:w-full'>
                    <div className='flex justify-center sm:justify-start sm:mt-6 w-full'>
                        <div>
                            <h2 className='font-bold text-lg text-white mb-2'>Usefull links</h2>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        <h2 className='font-bold text-lg text-white mb-2'>Join Our</h2>
                        <span className='text-white'>Get Email updates about our latest and shop specials offers</span>
                        <div className='h-[40px] w-full bg-white rounded-full overflow-hidden border relative'>
                            <input placeholder='Enter your mail' className='h-full bg-transparent w-full px-3 outline-0' type="text" />
                            <button className='h-full absolute right-0 bg-[#191919] text-white uppercase px-4 font-bold text-sm'>Subscribe</button>
                        </div>
            ...
            <div className='w-[85%] flex flex-wrap justify-center items-center text-white mx-auto py-5 text-center'>
                <span>Copiright ©2024 All rights reserved | Powered by  <a className='text-blue-500 underline' href="">@ridan-express</a></span>
            </div>
