...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Handle the Google sign-in success (e.g., send the user data to your backend)
  ...
  return (
    <div>
      ...
      <div className='bg-slate-200 mt-4'>
        <div className='w-full justify-center items-center p-10 md:p-1'>
          <div className='grid grid-cols-2 md:grid-cols-1 w-[60%] md:w-full mx-auto bg-white rounded-md'>
            <div className='px-8 py-8'>
              ...
              <div className='text-center text-slate-600 pt-1'>
                <p><a target='_blank' rel='noopener noreferrer' className='text-blue-500' href='http://localhost:3001/register'>Register</a> seller account</p>
              </div>
            </div>
            <div className='w-full h-full md:hidden py-4 pr-4'>
              <img className='w-full h-[95%]' src="http://localhost:3000/images/login.jpg" alt="Login Visual" />
            </div>
          </div>
        </div>
      </div>
