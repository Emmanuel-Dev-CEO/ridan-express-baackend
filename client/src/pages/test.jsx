help me restyle this code do not remove anything just make it resemble konga product detail page import React, { useEffect, useState } from "react";
        ...
        <div className="absolute left-0 top-0 w-full h-full bg-[#2422228a]">
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <div className="flex flex-col justify-center gap-1 items-center h-full w-full text-white">
              <h2 className="text-3xl font-bold">Ridan.ng</h2>
            </div>
          </div>
        </div>
      </div> */}
            ...
            <section>
                <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16">
                    <div className="grid grid-cols-2 md-lg:grid-cols-1 bg-black gap-1">
                        <div>
                            <div className=" rounded-[30px] bg-black h-[280px] w-[300px]  md:w-full md:h-[300px] md:flex item-center">
                                <img
                                    className="rounded-[30px] h-full w-full md:w-[90%] md:h-full"
                                        ...
                                        {product.images.map((img, i) => {
                                            return (
                                                <div key={i} onClick={() => setImage(img)}>
                                                    <img
                                                        className="h-[90px] rounded-[18px] cursor-pointer"
                                                        src={img}
                                                        alt=""
                                                    />
                                                </div>
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="flex flex-col gap-2">
                                <div className="text-3xl text-black items-baseline gap-2">
                                    {product.discount !== 0 ? (
                                        <>
                                            <span className="text-[50px] md:text-[30px] font-semibold text-[#191919]">
                                                NGN
                                                {product.price -
                                                    Math.floor((product.price * product.discount) / 100)}
                                            </span> <br />
                                            <span className="text-[20px] my-5 font-medium text-gray-500 line-through">
                                                NGN {product.price}
                                            </span>
                            ...
                            <div className="text-3xl font-medium text-black font-bold">
                                <h2>{product.name}</h2>
                            </div>
                            ...
                            <div className="text-[#191919] font-medium">
                                <h1>Location</h1>
                                <p className="text-[10px]">Shipping from {product.location} </p>
                            </div>
                            ...
                            <div className="pr-4 md-lg:pr-0">
                                <div className="grid grid-cols-2">
                                    <button
                                        ...
                                        className={`py-1 hover:text-white px-5 hover:bg-green-500 ${state === "reviews"
                                    ...
                                    <button
                                        ...
                                        className={`py-1 px-5 hover:text-white hover:bg-green-500 ${state === "description"
                                            ? "bg-green-500 text-white"
                                            : "bg-slate-200 text-slate-700"
                                            } rounded-sm`}
                                    >
